...
const changePasswordWithLengthValidation = require('../../controllers/changePasswordWithLengthValidation.service');
...
describe('changePassword function', () => {
  it('should change the password successfully', async () => {
    ...
    await changePasswordWithLengthValidation(req, res);
